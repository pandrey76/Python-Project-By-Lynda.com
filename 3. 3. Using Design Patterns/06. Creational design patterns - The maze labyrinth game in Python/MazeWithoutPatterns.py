...
#                print(side_str)
#                side_str = side_str.replace("<class '__main__.", "")
#                print(side_str)
#                side_str = side_str.replace("'>", "")
#                print(side_str)

                #print(str(side.__class__))
                side_str = str(side.__class__).replace("<class '__main__.", "").replace("'>", "")   #очень интересная запись надо разобраться
