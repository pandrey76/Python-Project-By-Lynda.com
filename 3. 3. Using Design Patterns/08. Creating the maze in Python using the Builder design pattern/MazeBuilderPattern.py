...
class MazeBuilder():
    ...
    def GetMaze(self):                      #   get the Maze
        return None                         #   overwrite to return Maze


class MazeGame():

    # Builder Design Pattern
    def CreateMaze(self, builder):          #   pass in MazeBuilder
        builder.BuildMaze()
    ...
    def CreateComplexMaze(self, builder):   #   pass in MazeBuilder
        builder.BuildRoom(1)
        #   ..
...
class  Interface_StandartMazeBuilder(MazeBuilder):
